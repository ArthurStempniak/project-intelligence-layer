...
`--raw` imprime só o pacote, sem relatório, porque qualquer texto de relatório na saída
...
O guia completo está em [`CONTRIBUTING.md`](CONTRIBUTING.md), em inglês para
alcançar contribuidores de fora. A regra que importa: **toda mudança em
recuperação de contexto precisa vir com o número do benchmark antes e depois.**
...
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | tour da arquitetura, como adicionar um parser, a regra do benchmark |
| [`SECURITY.md`](SECURITY.md) | o que nunca entra no índice, e como relatar vulnerabilidade |
